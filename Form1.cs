...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void sizeThings()
        {
            ...
            button4.Height = ht / 9;
            button4.Width = wt / 14;
            button1.Location = new Point(button5.Width+5, (ht/2));
            button3.Location = new Point(button1.Location.X+button1.Width + 10, (ht / 2) );
            button2.Location = new Point(button3.Location.X+button3.Width + 10, (ht / 2) );
            button4.Location = new Point(button2.Location.X+button2.Width + 10, (ht / 2) );
        }
